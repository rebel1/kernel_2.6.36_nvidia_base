 ...
 *
 */
static const char athId[] __attribute__ ((unused)) = "$Id: //depot/sw/releases/olca2.2/host/tools/athbtfilter/bluez/abtfilt_main.c#9 $";
...
main(int argc, char *argv[])
{
    ...
    while ((opt = getopt(argc, argv, "andczxf:w:")) != EOF) {
        switch (opt) {
        case 'n':
            daemonize = 0;
            break;
