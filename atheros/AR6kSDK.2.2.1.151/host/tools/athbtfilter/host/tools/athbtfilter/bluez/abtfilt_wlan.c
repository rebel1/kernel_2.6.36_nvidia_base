/*------------------------------------------------------------------------------ */
/* <copyright file="abtfilt_wlan.c" company="Atheros"> */
 ...
 *
 */
static const char athId[] __attribute__ ((unused)) = "$Id: //depot/sw/releases/olca2.2/host/tools/athbtfilter/bluez/abtfilt_wlan.c#7 $";
...
A_STATUS
Abf_WlanStackNotificationInit(ATH_BT_FILTER_INSTANCE *pInstance)
{
    A_STATUS status;
...
WirelessCustomEvent(ATH_BT_FILTER_INSTANCE *pInstance, char *buf, int len)
{
    ...
    do {
        ...
        case (WMI_CONNECT_EVENTID):
            ...
            pAbfWlanInfo->Channel = ev2->channel;
...
void Abf_WlanCheckSettings(A_CHAR *wifname)
{
    ...
    if (wifname[0] == '\0' && property_get("wifi.interface", ifprop, "wlan0")) {
