 ...
 *
 */
static const char athId[] __attribute__ ((unused)) = "$Id: //depot/sw/releases/olca2.2/host/tools/athbtfilter/bluez/abtfilt_utils.c#6 $";
...
#define A_VSYSLOG(level, msg, ap) vsyslog(level, msg, ap)
