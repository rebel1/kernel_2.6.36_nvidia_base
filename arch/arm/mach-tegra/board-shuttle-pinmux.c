/*
 * arch/arm/mach-tegra/board-shuttle-pinmux.c
 *
...
static __initdata struct tegra_pingroup_config shuttle_pinmux[] = {
...
static __initdata struct tegra_drive_pingroup_config shuttle_drive_pinmux[] = {
#if 1
	...
	{TEGRA_DRIVE_PINGROUP_DAP4,    TEGRA_HSM_DISABLE, TEGRA_SCHMITT_ENABLE,  TEGRA_DRIVE_DIV_1, TEGRA_PULL_18, TEGRA_PULL_22, TEGRA_SLEW_SLOWEST, TEGRA_SLEW_SLOWEST},
...
static struct tegra_gpio_table gpio_table[] = {
	...
	{ .gpio = SHUTTLE_KEY_VOLUMEUP,		.enable = true },
	{ .gpio = SHUTTLE_KEY_VOLUMEDOWN,	.enable = true },
	{ .gpio = SHUTTLE_KEY_POWER,		.enable = true },
	{ .gpio = SHUTTLE_KEY_RESUME,		.enable = true },
	{ .gpio = SHUTTLE_KEY_SUSPEND,		.enable = true },
	{ .gpio = SHUTTLE_KEY_BACK,			.enable = true },
	{ .gpio = SHUTTLE_CAMERA_POWER,		.enable = true },
	{ .gpio = SHUTTLE_NAND_WPN,			.enable = true },
	{ .gpio = SHUTTLE_BL_ENB,			.enable = true },
	...
	{ .gpio = SHUTTLE_SDIO2_CD,			.enable = true },
	{ .gpio = SHUTTLE_SDIO2_POWER,		.enable = true },
	{ .gpio = SHUTTLE_SDHC_CD,			.enable = true },
