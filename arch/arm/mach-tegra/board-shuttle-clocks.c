...
#else
	{ "sdmmc1",		"pll_p",		 25411764,	false},		/* sdhci-tegra.0 */
#endif
	
#if 1
	{ "sdmmc2",		"clk_p",		   400000,	false},		/* sdhci-tegra.1 */
	{ "sdmmc3",		"clk_m",		 12000000,	false},		/* sdhci-tegra.2 */
#else
...
#if 1
	{ "vde",		"pll_p",		 28800000,	false},		/* tegra-avp */
#else
